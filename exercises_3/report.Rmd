...
![Effect of Police on Crime](report_files/ex3table2.jpg)
...
![Reduction in Crime on High-Alert Days: Concentration on the National Mall](report_files/ex3table4.jpg)
...
```{r wine_k_sample_plots, echo=FALSE}
