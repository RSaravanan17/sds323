...
```{r abia4, echo=FALSE, fig.width = 10, fig.height = 10}
...
```{r abia5, echo=FALSE, fig.width = 10, fig.height = 4}
...
```{r abia6, echo=FALSE, fig.width = 10, fig.height = 4}
...
plot(creatinine$age, creatinine_res, ylab="Residuals", xlab="Age", main="Residual Plot of Creatinine Clearance Rate vs. Age")
abline(0, 0)
```
