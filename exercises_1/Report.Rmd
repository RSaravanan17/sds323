...
# Amenities and Precipitation

For some variables like amenities and precipitation, as shown above, green buildings generally cost more than non-green buildings. In addition, it seems evident that whether a building has amenities and the average amount of precipitation in the building’s geographic region has little correlation to whether a building’s rent changes with green adjustments. This shows that there are other controlling factors at play that aren't necessarily as simple as green vs non-green buildings.

All in all, we conclude that due to the sheer number of other variables at work here that explain some of the causality and correlation between green vs non-green buildings and higher rent, the analysis in the case study isn't entirely correct and is worth revisiting.